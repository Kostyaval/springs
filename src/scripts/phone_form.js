...
function validatePhone(txtPhone) {
    var filter = /^(\+?[0-9]{12})|(\([0-9]{3}\)\s+[0-9]{3}\-[0-9]{4})+$/;

    return filter.test(txtPhone)}

console.log(validatePhone("+380504264"));
...
function handleFormSubmit(event) {  // handles form submit withtout any jquery
    ...
    */
    ...
    if(!validatePhone(data.phone) ) {   // if email is not valid show error
        document.getElementById('phone_holder').classList.add("js_error");
        return false
    } else {
